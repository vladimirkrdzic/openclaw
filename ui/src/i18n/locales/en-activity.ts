  ...
  activity: {
    ...
    runInspector: {
      ...
      decisions: {
        ...
        ownerHeading: "Owner and durability",
        durableOwnerLabel: "Durable record owner",
        boundaryLabel: "Decision boundary",
        ownerNote:
          "This read-only projection comes from the recorded owner. The Control UI does not re-evaluate the action or infer a reason.",
